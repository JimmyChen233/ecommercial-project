# Generated by Django 3.2.8 on 2021-10-06 15:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addr', models.CharField(max_length=256, verbose_name='Shipping Address')),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Owned account')),
            ],
            options={
